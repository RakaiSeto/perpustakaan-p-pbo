...
public class Peminjaman extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(txtIdPeminjaman, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
                                    .addComponent(cmbBuku, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGap(95, 95, 95)))
                        .addGap(121, 121, 121))))
        );
    ...
    public void tampilCmb() {
        cmbBuku.setModel(new javax.swing.DefaultComboBoxModel(new backend.Buku().getAll().toArray()));
        cmbAnggota.setModel(new javax.swing.DefaultComboBoxModel(new backend.Anggota().getAll().toArray()));
        cmbPegawai.setModel(new javax.swing.DefaultComboBoxModel(new backend.Pegawai().getAll().toArray()));
    }
...
//        get value from text field
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        pem.setAnggota((backend.Anggota) cmbAnggota.getSelectedItem());
        pem.setBuku((backend.Buku) cmbBuku.getSelectedItem());
        pem.setPegawai((backend.Pegawai) cmbPegawai.getSelectedItem());
    ...
    public void tampilkanData() {
        String[] kolom = {"ID", "Anggota", "Buku", "Pegawai", "Tanggal Pinjam"};
