...
//        get value from text field
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        backend.Kategori kat = new backend.Kategori();
    ...
    public void tampilkanData() {
        ...
        ArrayList<backend.Kategori> list = new backend.Kategori().getAll();
        Object[] rowData = new Object[3];

        tblKategori.setModel(new DefaultTableModel(new Object[][]{}, kolom));

        for (backend.Kategori kat : list) {
    ...
    public void cari (String keyword) {
        String[] kolom = {"ID", "nama", "keterangan"};
        ArrayList<backend.Kategori> list = new backend.Kategori().search(keyword);
        Object[] rowData = new Object[3];
